    ...
    <div class="container ">
        ...
        <div class="left-content push-left">
            <div id="breadcam" role="navigation" aria-label="breadcrumb">
                <ul class="breadcrumbs"><li><a href="" class="home"><span>Home</span></a></li><li><a href="about-district/">About District</a></li>  <li class="current">District at a Glance</li></ul>            </div>
        </div>
